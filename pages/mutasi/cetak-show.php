...
$pdf->cell(2, 7, ':', 0, 0, 'L');
$pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['nama_mutasi']), 0, 50), 0, 1, 'L');
...
$pdf->cell(2, 7, ':', 0, 0, 'L');
$pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['alamat_ktp_mutasi']), 0, 100), 0, 1, 'L');

$pdf->cell(45, 7, 'Alamat Pindah', 0, 0, 'L');
$pdf->cell(2, 7, ':', 0, 0, 'L');
$pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['alamat_mutasi']), 0, 100), 0, 1, 'L');
