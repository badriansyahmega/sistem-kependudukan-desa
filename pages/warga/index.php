      ...
      <td>
        ...
        <div class="btn-group pull-right">
          ...
          <ul class="dropdown-menu pull-right" role="menu">
            ...
            <li>
              <a href="../meninggal/create.php?id_warga=<?php echo $warga['id_warga'] ?>"><i class="glyphicon glyphicon-export"></i> meninggal</a>
            </li>
            <li class="divider"></li>
            <li>
...
<ul class="list-group">
  <li class="list-group-item"> <dt>Total Warga</dt>
  ...
  <li class="list-group-item"> <dt>Jumlah Perempuan</dt>
    <dd><?php echo $jumlah_warga_p['total'] ?> orang</dd>
</li>
  <li class="list-group-item"> <dt>Warga < 17 tahun</dt>
    <dd><?php echo $jumlah_warga_kd_17['total'] ?> orang</dd></li>
    
  <li class="list-group-item"> <dt>Warga >= 17 tahun</dt>
    <dd><?php echo $jumlah_warga_ld_17['total'] ?> orang</dd></li>
</ul>
</dl>
</div>
